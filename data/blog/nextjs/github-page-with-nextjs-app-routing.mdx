---
title: Github page with nextjs app router
date: '2023-10-22'
tags: ['nextjs', 'github page', 'gh-pages', 'static exports', 'generateStaticParams', 'app router']
draft: false
summary: Create github page in nextjs using static exports and generateStaticParams
---
